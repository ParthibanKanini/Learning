...
public class PullRequestThread {
  ...
  public PullRequestThread(final String threadId, final String status, final boolean isDeleted) {
  ...
  public void addCommenter(final String author, final List<ThreadComment> comments) {
